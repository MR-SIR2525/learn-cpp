...
{	const int NUM_EMPS = 5;             // Number of employees
	vector <int> hours(NUM_EMPS);       // Define a vector of integers, size defined though opitonal
	vector <double> payRate(NUM_EMPS);  // Define a vector of doubles, size defined though opitonal
